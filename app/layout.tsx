...
export const metadata: Metadata = {
  ...
  title: {
    default: '여쌤과외 | 전국 초등 중등 고등 영어과외 수학과외 방문과외 화상과외',
    template: '%s | 여쌤과외',
  },
  description:
    '여쌤과외는 전국 방문과외와 화상과외를 운영합니다. 초등, 중등, 고등 영어과외, 수학과외, 국어, 과학, 사회까지 1:1 맞춤수업을 제공하며 내신 대비와 시험 대비를 체계적으로 지도합니다.',
  keywords: ['여쌤과외', '영어과외', '수학과외', '방문과외', '화상과외', '초등과외', '중등과외', '고등과외', '내신 대비', '시험 대비', '1:1 과외'],
